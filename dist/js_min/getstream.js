  ...
  return (() => {
    var e = {
        ...
        6663: (e, t, n) => {
          ...
          (g.prototype = new Error()), (g.prototype.name = 'InvalidCharacterError');
          var y =
            ('undefined' != typeof window && window.atob && window.atob.bind(window)) ||
            function (e) {
              var t = String(e).replace(/=+$/, '');
              if (t.length % 4 == 1) throw new g("'atob' failed: The string to be decoded is not correctly encoded.");
              for (
                var n, r, i = 0, s = 0, o = '';
                (r = t.charAt(s++));
            ...
            L = (function () {
              function e(t, n, r) {
                                ...
                                switch ((e.prev = e.next)) {
                                  case 0:
                                    return (
                                      ...
                                      (e.prev = 1),
                                      (e.next = 4),
                                      u.request(u.enrichKwargs(P({ method: t }, n)))
                                    );
                                  case 4:
                                    return (r = e.sent), e.abrupt('return', u.handleResponse(r));
                                  case 8:
                                    if (((e.prev = 8), (e.t0 = e.catch(1)), !e.t0.response)) {
                                      e.next = 12;
                                      break;
                                    }
                                    return e.abrupt('return', u.handleResponse(e.t0.response));
                                  case 12:
                                    throw new C.z4(e.t0.message);
                                  case 13:
                                  case 'end':
                                    return e.stop();
                                }
                ...
                if (
                  ...
                  var g = void 0 === this.options.keepAlive || this.options.keepAlive;
                  this.nodeOptions = {
                    httpAgent: new p.Agent({ keepAlive: g, keepAliveMsecs: 3e3 }),
                    httpsAgent: new v.Agent({ keepAlive: g, keepAliveMsecs: 3e3 }),
                  };
                }
                if (
                  ((this.request = f().create(
                    P({ timeout: this.options.timeout || 1e4, withCredentials: !1 }, this.nodeOptions || {}),
                  )),
              ...
              return (
                (0, a.Z)(e, [
                  ...
                  },
                  {
                    key: 'userAgent',
                    value: function () {
                      return 'stream-javascript-client-'.concat(this.node ? 'node' : 'browser', '-').concat(D.version);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = e.method,
                        n = e.token,
                        r = (0, i.Z)(e, ['method', 'token']);
                      return P(
                        {
                          method: t,
                          url: this.enrichUrl(r.url, r.serviceName),
                          data: r.body,
                          params: P({ api_key: this.apiKey, location: this.group }, r.qs || {}),
                          headers: P(
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      ...
                      return this.get({ url: u, qs: P(P({}, r), s), token: c });
                    },
                  },
                  {
                            ...
                            function (e) {
                              for (;;)
                                switch ((e.prev = e.next)) {
                                  ...
                                  case 2:
                                    return delete (n = P({}, t)).id, (e.next = 6), this.currentUser.getOrCreate(n);
                                  case 6:
                                ...
                                switch ((e.prev = e.next)) {
                                  ...
                                  case 2:
                                    return (
                                      (n = e.sent),
                                      (s = n.activities),
                                      (o = (0, i.Z)(n, ['activities'])),
                                      (a = (0, r.Z)(s, 1)),
                                      (c = a[0]),
                                      e.abrupt('return', P(P({}, c), o))
                                    );
                                  case 7:
                                  case 'end':
                                    return e.stop();
        ...
        1964: (e, t, n) => {
          ...
          var a = n(484);
          function c(e, t) {
            return !t || ('object' !== (0, a.Z)(t) && 'function' != typeof t) ? i(e) : t;
          }
          function u(e) {
          ...
          var v = 'function' == typeof Error.captureStackTrace,
            g = !!new Error().stack,
            y = (function (e) {
              o(n, e);
              var t = p(n);
              function n(e) {
                ...
                return (
                  (0, r.Z)(this, n),
                  (s = t.call(this, e)),
                  (0, d.Z)(i(s), 'message', void 0),
                  (s.message = e),
                  v ? Error.captureStackTrace(i(s), n.constructor) : (s.stack = g ? new Error().stack : ''),
                  s
                );
              }
              return n;
            ...
            w = (function (e) {
              ...
              function n(e, s, o) {
                ...
                return (
                  (0, r.Z)(this, n),
                  (a = t.call(this, e)),
                  (0, d.Z)(i(a), 'error', void 0),
                  (0, d.Z)(i(a), 'response', void 0),
                  (a.error = s),
                  (a.response = o),
                  a
                );
                  ...
                  },
                  {
                    ...
                    value: function (e) {
                      var t = e.user_id,
                        n = e.activity_id,
                        i = e.reaction_id,
                        s = (0, r.Z)(e, ['user_id', 'activity_id', 'reaction_id']);
                      ...
                      var o = (t ? 'user_id' : n && 'activity_id') || (i && 'reaction_id'),
                        c = t || n || i,
                        u = e.kind ? this.buildURL(o, c, e.kind) : this.buildURL(o, c);
                      return this.client.get({ url: u, qs: s, token: this.token });
                    },
                  },
                  {
                    key: 'update',
        ...
        1955: (e, t, n) => {
          ...
          c(_.prototype, l), c(_.prototype, f), c(_.prototype, h), c(_.prototype, g), (e.exports = _);
        },
        8854: (e, t, n) => {
          'use strict';
          var r = n(8702),
        ...
        5666: (e) => {
          var t = (function (e) {
            ...
            var k = (m.prototype = g.prototype = Object.create(_));
            function E(e) {
